...
public class HumanRoundPlayer extends RoundPlayer {
    ...
    private Integer getCardToPlay() {
        ...
        // TODO: Implementar lógica para seleccionar la carta a jugar siguiendo estos pasos:DONE
        //   1. Mostrar este mensaje "This are the cards in your hand:"DONE
        //   2. Mostrar las cartas en la mano del jugador con este formato "i - carta" donde i es el índice de la carta.DONE
        //   3. Mostrar este mensaje "Please, select a card to play:"DONE
        //   4. Pedir al usuario que seleccione una carta usando el scanner.nextInt().DONE
        //    IMPORTANTE: Controlar respuesta valida del usuario, si es inválida,DONE
        //    mostrar el mensaje "Invalid input. Please, insert a number to get a valid option."DONE
        //   5. Retornar el índice de la carta seleccionada.DONE
        //    IMPORTANTE: Retornar un número válido, donde el indice es mayor = 0 y menor al tamañoDONE
        //    de la listad e cartas en la mano. Si el valor no se encuentra en el rango,DONE
        //    mostrar el mensaje "Invalid card. Please, select a valid card."DONE
