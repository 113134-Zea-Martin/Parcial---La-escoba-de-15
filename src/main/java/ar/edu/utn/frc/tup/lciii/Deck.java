...
public class Deck {
    ...
    private void createDeck() {
        for (int i = 1; i <= 7; i++) {
            cards.add(new Card(CardSuit.OROS, i, i));
            cards.add(new Card(CardSuit.COPAS, i, i));
            cards.add(new Card(CardSuit.ESPADAS, i, i));
            cards.add(new Card(CardSuit.BASTOS, i, i));
        }
        for (int i = 8; i <= 10; i++) {
            cards.add(new Card(CardSuit.OROS, i + 2, i));
            cards.add(new Card(CardSuit.COPAS, i + 2, i));
            cards.add(new Card(CardSuit.ESPADAS, i + 2, i));
            cards.add(new Card(CardSuit.BASTOS, i + 2, i));
        }
        // TODO: Implementar la creación de las cartas del mazo. Recuerde que son barajas de 40 cartas.DONE
